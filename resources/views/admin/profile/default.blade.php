       ...
       <div class="card">                	
         <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-3">
                    <a href="{{ route('export_master_data', ['type' => 'profile']) }}" class="btn btn-warning">Export all Profile to Excel</a>
                </div>
                <div class="col-3">
                    <a  class="btn btn-success" rel="tooltip"  data-bs-toggle="modal" data-bs-target="#centerprices">Export Center Prices to Excel</a>
                </div>
                <div class="col-3">
