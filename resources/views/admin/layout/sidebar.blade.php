   ...
   <ul class="side-menu app-sidebar3">
    ...
    <li class="slide">
         <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
            ...
            <span class="side-menu__label">{{__("message.Blog")}}</span><i class="angle fe fe-chevron-right"></i>
         </a>
         <<ul class="slide-menu">
    ...
    <li class="slide">
         <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
            ...
            <span class="side-menu__label">{{__("message.Content")}}</span><i class="angle fe fe-chevron-right"></i>
         </a>
         <<ul class="slide-menu">
